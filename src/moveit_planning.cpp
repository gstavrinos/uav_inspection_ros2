...
public:
    MoveItPlanning(std::string name, rclcpp::NodeOptions node_options, rclcpp::Node::SharedPtr move_group_node) : Node(name, node_options) {
        ...
        posestamped_sub_ = this->create_subscription<geometry_msgs::msg::PoseStamped>("moveit_planning/goal", 10, std::bind(&MoveItPlanning::poseStampedCallback, this, std::placeholders::_1));
